...
def run():
    ...
    with tf.Session() as sess:
        ...
        image_input, keep_prob, layer3_output, layer4_output, layer7_output = load_vgg(sess, vgg_path)
        final_output = layers(layer3_output, layer4_output, layer7_output, num_classes)
        logits, train_op, cross_entropy_loss = optimize(final_output, correct_label, learning_rate, num_classes)
